...
public final class HttpUtil {
    ...
    static {
        ...
        RequestConfig requestConfig = RequestConfig.custom().setSocketTimeout(113000).setConnectTimeout(113000).setConnectionRequestTimeout(31000).build();
    ...
    public static final String getWithHeader(String url, Map<String, String> headers) throws Exception {
        HttpGet httpGet = new HttpGet(url);
